...
```
'전자정부 표준프레임워크 DAO 단위 테스트 코드 생성' 짧은 제미나이 프롬프트 md 다운로드
```

```
@"md/cen-단위 테스트 코드 생성_v0.1_이백행_2026-05-21a.md" 컨텍스트 반영
```

```
@"md/cen-단위 테스트 코드 생성_v0.1_이백행_2026-05-21a.md" 컨텍스트 적용
```
